...
volatile int LED_array[] = {7, 8, 9, 10}; // Order is blue lime green red {14,15}; //{DAC0,DAC1}; {52,51};//{8,10,12,6}; //these pins have LEDs attached to them.  (DAC0 and DAC1 are true analog output pins / referred to as DAC1 and DAC2 on the board)
